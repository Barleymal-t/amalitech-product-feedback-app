import { NewSuggestion, InputSection } from "../pages/page_styles";
...
import { Params } from "../pages/SuggestionDetailsPage";
...
const EditSuggestionModal = ({ onClick }: { onClick: () => void }) => {
        ...
        <form action="" onSubmit={handleSubmit(submitData)}>
          ...
          <div className="flex">
            <Button
              ...
              type="button"
              onClick={() => {
                dispatch(suggestionDeleted(suggestion?.id));
                navigate("/");
              }}
            >
              Delete
